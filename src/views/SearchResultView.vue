    ...
    <div class="w-full max-w-4xl">
      ...
      <div class="mb-6 sm:mb-8 flex justify-center">
        <router-link to="/" class="flex flex-col items-center gap-1 group">
          <ChevronUpIcon class="w-10 h-10 sm:w-12 sm:h-12 text-white/90 nav-icon-dark
                                stroke-[1.2] group-hover:opacity-100" />
          <span class="text-xl sm:text-2xl font-quicksand text-white font-bold nav-label-dark
        ...
        <div class="glass-strong rounded-2xl sm:rounded-3xl p-6 sm:p-12">
          ...
          <div class="mb-8 sm:mb-10 text-center">
            ...
            <p class="text-base sm:text-xl text-gray-600 leading-relaxed nav-label-dark">
              ...
              <span class="font-semibold text-gray-800 nav-label">„{{ searchQueryText }}"</span>
          ...
          <div v-else class="space-y-4 sm:space-y-6">
            <h3 class="text-lg sm:text-xl text-gray-700 font-semibold nav-label-dark mb-3 sm:mb-4">Relevante Themen für dich:</h3>
              ...
              >
                <div class="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl
                              bg-white/15 flex items-center justify-center text-2xl sm:text-3xl shrink-0">
                    {{ result.emoji }}
                  </div>
                  <div>
          ...
          <div class="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-white/20">
            <router-link
                to="/library"
                class="block w-full py-3 sm:py-4 glass hover:bg-white/30 rounded-full
                     text-violet-700 font-bold text-base sm:text-lg text-center transition-all nav-label"
            >
...
async function doSearch() {
  ...
  try {
    ...
    emergencyResources.value = searchArticles.getEmergencyResources?.() ?? null
  } catch (e) {
