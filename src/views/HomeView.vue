<template>
  <!--
    HomeView.vue – Startseite + Bibliothek als vertikale Snap-Sektionen.
  ...
  <div
      ref="snapContainer"
      class="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth scrollbar-hide overscroll-contain"
  >

    <!-- GradualBlur am unteren Bildschirmrand -->
    <GradualBlur
        target="page"
        position="bottom"
        height="4rem"
    ...
    <!-- ═══ SEKTION 1: STARTSEITE ═══ -->
    <div id="home" class="h-screen snap-start flex flex-col">
        ...
        <div class="w-full max-w-4xl">
          ...
          <div class="flex justify-center mb-10 sm:mb-14">
            <svg
                ...
                viewBox="0 0 298.43 71.54"
                class="h-20 sm:h-28 md:h-36 w-auto"
                overflow="visible"
                fill="none"
            >
          ...
          <!-- Bibliothek Button (scrollt nach unten) -->
          <button
              @click="scrollToLibrary"
              class="flex flex-col items-center gap-1 mx-auto w-fit group
                   transition-opacity hover:opacity-85"
          >
            <span class="nav-label-dark text-3xl sm:text-4xl font-quicksand text-white font-bold
                         group-hover:text-white transition-colors">
              Bibliothek
            </span>
            <ChevronDownIcon class="nav-icon-dark w-10 h-10 sm:w-12 sm:h-12 text-white/90
    ...
    <!-- ═══ SEKTION 2: BIBLIOTHEK ═══ -->
    <div id="library" class="min-h-screen snap-start px-4 md:px-8 pt-2 sm:pt-4 pb-6 sm:pb-8">
      ...
      <div class="flex justify-center mb-6 sm:mb-8">
        <button
            ...
            class="flex flex-col items-center gap-1 group
                 transition-opacity hover:opacity-85"
        >
          <ChevronUpIcon class="nav-icon-dark w-10 h-10 sm:w-12 sm:h-12 text-white/90
                                  stroke-[2.5] group-hover:text-white transition-colors" />
          <span class="nav-label-dark text-3xl sm:text-4xl font-quicksand text-white font-bold
                       group-hover:text-white transition-colors">
            Home
      ...
      <!-- Bibliothek Inhalt (wiederverwendbare Komponente) -->
      <LibrarySection />
